...
const CallEnSettingsScreen = ({
  savedMontPlacesReal,
  setSavedMontPlacesReal,
}) => {
    ...
    <TouchableWithoutFeedback onPress={handleOutsidePress}>
      <View
        ...
        <View style={styles.rowSettingsView}>
          <Text style={styles.whiteOrbitronText}>Your photo:</Text>
                      ...
                      },
                      {
                        ...
                        onPress: async () => {
                          ...
                          try {
                            ...
                            console.error(
                              'Error deleting image from AsyncStorage: ',
                              error,
                            );
                          }
                        },
        ...
        <View
          ...
          <View>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.orbitronOrangeText}>Delete all data</Text>
...
const createCallEnSettingsStyles = dimensions =>
  StyleSheet.create({
    onOffText: {
      color: '#818181',
      textTransform: 'uppercase',
