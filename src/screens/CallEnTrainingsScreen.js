...
const CallEnTrainingsScreen = ({
  ...
  const handleDeleteTraining = async workoutId => {
    const newWorkouts = ownedWorkouts.filter(
      ...
      {!isTrainingOpened && !isTrainingStarted ? (
        ownedWorkouts.length === 0 ? (
          ...
          <ScrollView
            ...
            style={{flex: 1, paddingBottom: dimensions.height * 0.1}}>
            {ownedWorkouts.map((workout, index) => (
              <View
                ...
                <View
                  ...
                  <Image
                    source={
                      workoutIcons.find(
                        icon =>
                          icon.callEmWorkoutTitle === workout.workoutCategory,
                      ).callEmWorkoutIcon
                    }
                    style={{
                  ...
                  <Text style={styles.orbitronOrangeText}>{workout.title}</Text>
                </View>
                ...
                <View
                  ...
                  <View>
                    <Text style={styles.cardSilverText}>Repetitions</Text>
                  ...
                  <View>
                    <Text style={styles.cardSilverText}>Execution time:</Text>
                  ...
                  <View>
                    <Text style={styles.cardSilverText}>Rest time:</Text>
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Text style={styles.orbitronText}>Start training</Text>
                  </TouchableOpacity>
        ...
        <View style={styles.whiteCardView}>
          <Image
            source={
              workoutIcons.find(
                icon =>
                  icon.callEmWorkoutTitle === selectedTraining.workoutCategory,
              ).callEmWorkoutIcon
            }
            style={{
          ...
          <View
            ...
            <Image
              source={
                workoutIcons.find(
                  icon =>
                    icon.callEmWorkoutTitle ===
                    selectedTraining.workoutCategory,
                ).callEmWorkoutIcon
              }
              style={{
                width: dimensions.width * 0.1,
          ...
          <View
            ...
            <View
              ...
              {Array.from({length: 60}).map((_, i) => {
                ...
                const totalTicks = 60;
                const totalTime = selectedTraining
                  ? selectedTraining.executionTime * 60
                  : 0;
                const elapsedTime = totalTime - remainingTime;
                const progressFraction = totalTime
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              />
              <Text style={styles.orbitronText}>Restart</Text>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                shareCallEnToSportTrainingResults(
                  selectedTraining.workoutCategory,
                );
              }}
              style={{
...
const createCallEnStyles = dimensions =>
  StyleSheet.create({
    linearGradieint: {
      position: 'absolute',
      left: 0,
